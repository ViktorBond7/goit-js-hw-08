...
galleryEll.style.flexWrap = 'wrap';
galleryEll.style.maxWidth = '1440px';
galleryEll.style.rowGap = '48px';
galleryEll.style.columnGap = '24px';
galleryEll.style.justifyContent = 'center';
